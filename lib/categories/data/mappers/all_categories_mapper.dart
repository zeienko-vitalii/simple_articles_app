...
class AllCategoriesMapper
    implements Mapper<GAllCategoriesData_categories, Category> {
  @override
  Category map(GAllCategoriesData_categories from) {
    return Category(
      id: from.id,
      title: from.title,
      articles: [
        ...from.articles.map(
          (e) => Article.fromJson(e.toJson()),
        ),
      ],
    );
  }
